...
> 
> You can provide your feedback by [creating an Issue](https://github.com/SubhanshuMG/Docker-shrink/issues?q=sort%3Aupdated-desc+is%3Aissue+is%3Aopen) in this repository.
...
```
5. [Create a new release](https://github.com/SubhanshuMG/Docker-shrink/releases/new) in this repository
